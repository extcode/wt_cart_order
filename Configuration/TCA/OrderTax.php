...
$TCA['tx_wtcartorder_domain_model_ordertax'] = array(
	...
	'interface' => array(
		'showRecordFieldList' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, name, value, calc, sum',
	),
	'types' => array(
		'1' => array('showitem' => 'sys_language_uid;;;;1-1-1, l10n_parent, l10n_diffsource, hidden;;1, name, value, calc, sum,--div--;LLL:EXT:cms/locallang_ttc.xml:tabs.access,starttime, endtime'),
	),
	'palettes' => array(
		'1' => array('showitem' => ''),
	),
	'columns' => array(
		...
		'l10n_parent' => array(
			...
			'config' => array(
				...
				'foreign_table_where' => 'AND tx_wtcartorder_domain_model_ordertax.pid=###CURRENT_PID### AND tx_wtcartorder_domain_model_ordertax.sys_language_uid IN (-1,0)',
			),
		),
